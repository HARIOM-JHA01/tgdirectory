...
const Tag: React.FC<TagProps> = ({ number, value, onChange, error }) => {
    ...
    return (
        <div className="mb-4">
            <div
                className={`w-full bg-white rounded-lg overflow-hidden border ${error ? "border-red-500" : "border-gray-300"
                    }`}
            >
                <input
                    type="text"
...
const SubmitLink: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setErrors({});
        // Link validation: first character must be capital
        if (!link || link.length === 0 || link[0] !== link[0].toUpperCase()) {
            setErrors({
                sl_link: "our platform only accepted Public Link under Character First T.me/A",
            });
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            <input
                                type="text"
                                placeholder={t("LTI")}
                                className={`w-full px-4 py-3 rounded-lg border text-gray-700 ${errors.sl_title
                                    ? "border-red-500"
                                    : "border-gray-300"
                                    }`}
                                value={title}
                        ...
                        <div className="mb-4">
                            <textarea
                                placeholder={t("DSC")}
                                className={`w-full px-4 py-3 rounded-lg border text-gray-700 h-32 ${errors.sl_description
                                    ? "border-red-500"
                                    : "border-gray-300"
                                    }`}
                                value={description}
                        ...
                        <div className="mb-4">
                            ...
                            <div
                                className={`flex w-full border rounded-lg overflow-hidden ${errors.sl_link
                                    ? "border-red-500"
                                    : "border-gray-300"
                                    }`}
                            >
